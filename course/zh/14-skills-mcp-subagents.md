# 第 14 章 —— Skills、MCP 与 subagents：同一种能力的三种形态
...
### Skills —— progressive disclosure（渐进式披露，简述）
...
### Skills —— 来源、信任与 prompt-injection 风险
